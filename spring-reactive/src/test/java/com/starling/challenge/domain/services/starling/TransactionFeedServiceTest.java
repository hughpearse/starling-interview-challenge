...
public class TransactionFeedServiceTest {
    ...
    public void testGetTransactionFeedForWeek() throws Exception {
        ...
        when(transactionService.getTransactionFeedForWeek(account.getAccountUid(), weekStarting)).thenReturn(Mono.just(testFeedItems));

        // Act: perform the test
        Mono<FeedItems> result = transactionService.getTransactionFeedForWeek(account.getAccountUid(), weekStarting);
