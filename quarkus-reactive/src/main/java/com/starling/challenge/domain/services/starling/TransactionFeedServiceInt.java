...
public interface TransactionFeedServiceInt {
     ...
     */
    public Uni<FeedItems> getTransactionFeed(UUID accountUid, Date weekStarting, Date weekEnding);
     ...
     * @return the FeedItems object
     */
    public Uni<FeedItems> getTransactionFeedForWeek(UUID accountUid, Date weekStarting);
}
