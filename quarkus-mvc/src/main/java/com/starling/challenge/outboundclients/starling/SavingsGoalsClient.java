...
public interface SavingsGoalsClient {
    ...
    public SavingsGoalsV2 getSavingsGoals(@PathParam("accountUid") UUID accountUid);

    @PUT
    @Path("/account/{accountUid}/savings-goals")
    public CreateOrUpdateSavingsGoalResponseV2 createSavingsGoal(@PathParam("accountUid") UUID accountUid, SavingsGoalRequestV2 savingsGoalRequestV2);
